...
Summary(pl):	Serwer dºwiÍku dla WindowMakera
Name:		WSoundServer
Version:	0.4.0
Release:	3
License:	GPL
...
%description -l pl
WSoundServer jest serwerem dºwiÍku dla WindowMakera.

%package devel
Summary:	WSoundServer libraries and headers
Summary(no):	Utviklings bibliotek for WSoundServer
Summary(fr):	BibliothËques et includes pour WSoundServer
Summary(pl):	Biblioteki i pliki nag≥Ûwkowe dla WSoundServer
...
BibliothËques et includes pour WSoundServer.

%description devel -l no
WSoundServer biblioteket samt ´headerfilenª.

%description devel -l pl
Biblioteki i pliki nag≥Ûwkowe dla WSoundServer.

%package static
Summary:	WSoundServer static libraries
Summary(fr):	BibliothËques statiques pour WSoundServer
...
BibliothËques statiques pour WSoundServer.
